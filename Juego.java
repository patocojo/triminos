...
public class Juego
{
    ...
    /**
     * Mï¿½todo que realiza la resoluciï¿½n por Divide y Vencerï¿½s del juego. 
     * 
     * El algoritmo es el siguiente:
     * 
     *   (0) Caso trivial: 2x2 y una casilla marcada. Los otros 3 forman un trimino y solucionado.
     *   (1) Ver en quï¿½ cuadrante estï¿½ la casilla marcada
     ...
     *   (4) Para los cuatro cuadrantes soluciï¿½n resultantes, extraer su lista de triminos y aï¿½adirla a la lista de triminos del tablero soluciï¿½n
     *   (5) devolver el tablero soluciï¿½n
     *
     */
    public Tablero  resolver(Tablero t)
    {
        ...
        else
        {
            ...
            // COMBINACIï¿½N DE LAS SOLUCIONES PARCIALES Paso (4)
